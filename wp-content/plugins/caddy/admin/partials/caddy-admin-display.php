...
<div class="wrap">
		...
		<div class="notice cc-welcome-notice is-dismissible" data-cc-dismissible-notice="welcome">
			...
			<div class="cc-notice-text">
				...
				echo sprintf(
					...
					esc_url( 'https://support.usecaddy.com/article-categories/getting-started/?utm_source=welcome-notice&amp;utm_medium=plugin&amp;utm_campaign=plugin-links' ),
	...
	<div class="cc-settings-wrap">
		...
		<div class="cc-notices-container">
			...
			<div class="cc-box cc-links">
				...
				<ul>
					<li>
						<a href="https://support.usecaddy.com/?utm_source=caddy-plugin&amp;utm_medium=plugin&amp;utm_campaign=plugin-links"><?php echo esc_html( __( 'Read the documentation', 'caddy' ) ); ?></a>
					</li>
					<li>
						<a href="https://www.facebook.com/groups/woocommercepros"><?php echo esc_html( __( 'Join Our Facebook group', 'caddy' ) ); ?></a>
					</li>
					<li>
					...
					<li>
						<a href="https://support.usecaddy.com/submit-a-ticket/?utm_source=caddy-plugin&amp;utm_medium=plugin&amp;utm_campaign=plugin-links"><?php echo esc_html( __( 'Contact support', 'caddy' ) ); ?></a>
					</li>
				</ul>
			</div>
	...
	<div class="cc-footer-links">
		...
		| <a href="<?php echo esc_url( 'https://wordpress.org/support/plugin/caddy/reviews/' ); ?>" target="_blank"><?php echo esc_html( __( 'Leave a Review', 'caddy' ) ); ?></a>
		| <a href="<?php echo esc_url( 'https://support.usecaddy.com/' ); ?>" target="_blank"><?php echo esc_html( __( 'Get Support', 'caddy' ) ); ?></a>
		<?php
		$caddy_license_status = get_option( 'caddy_premium_edd_license_status' );
		if ( ! isset( $caddy_license_status ) || 'valid' !== $caddy_license_status ) {
			?>
			| <a href="<?php echo esc_url( 'https://www.usecaddy.com' ); ?>" target="_blank"><?php echo esc_html( __( 'Go Premium', 'caddy' ) ); ?></a>
		<?php } ?>
	</div>
</div>